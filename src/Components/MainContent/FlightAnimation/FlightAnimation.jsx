      ...
      >
        ...
        >
          ...
          <motion.path
            ...
            transition={{ delay: !isXs ? 1.4 : 0.4, duration: 0.9 }}
          />
          <motion.path
            d={SVGportugalText}
            ...
            transition={{ delay: !isXs ? 1 : 0, duration: 1.4 }}
          />
        </g>
        {/* Portugal - end */}
        ...
        >
          ...
          <motion.path
            ...
            initial={{ pathLength: 0, opacity: 0.5 }}
            animate={{ pathLength: 1, opacity: 1 }}
            transition={{ delay: !isXs ? 1 : 0, duration: 0.4 }}
          />
        </g>
        {/* CALI - END */}
        ...
        <motion.g
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: !isXs ? 2 : 1, duration: 0.2 }}
        >
          <motion.path
            ref={path}
            id="track"
        ...
        <motion.g
          initial={{ x: -20, y: -10 }}
          animate={{ x: 0, y: 0 }}
          transition={{ delay: !isXs ? 2 : 1, duration: 0.6 }}
        >
          <g ref={star}>
            <motion.path
              id="plane"
